...
const insertBlock = `      if (res.ok && data.success) {
...
// Insert the block exactly at line index 404 (which is line 405 in 1-based index)
lines.splice(404, 0, insertBlock);

fs.writeFileSync(file, lines.join('\n'));
console.log('Fixed SettingsPage.jsx using array splice');
